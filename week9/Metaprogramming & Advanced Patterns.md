...
Use introspection and dynamic dispatch frequently when appropriate. Use descriptors and `__init_subclass__()` when building reusable frameworks. Reserve metaclasses for genuine class-creation problems that cannot be solved cleanly with simpler tools.[[docs.python](https://docs.python.org/3/library/inspect.html)][[docs.python](https://docs.python.org/3/library/importlib.html)]
